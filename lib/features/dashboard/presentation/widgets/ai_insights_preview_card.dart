                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('AI Portfolio Analysis', style: theme.textTheme.titleMedium),
                        Text(
                ...
                data: (walletState) {
                  if (walletState.isConnected) {
                            ...
                            children: [
                              ...
                              ref
                                  ...
                                  .when(
                                    ...
                                    error:
                                        (_, _) => Text('Unable to generate insight', style: theme.textTheme.bodySmall),
                                  ),
                            ],
                          ),
                        ),
                    ...
                    return Container(
                      ...
                      child: Column(
                        children: [
                          Icon(Icons.lock_outline, color: theme.colorScheme.onSurfaceVariant, size: 32),
                          const SizedBox(height: AppSpacing.sm),
                          Text(
