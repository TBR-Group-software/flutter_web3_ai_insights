...
class ComponentThemes {
  ...
  static ElevatedButtonThemeData elevatedButtonTheme(ColorScheme colorScheme) {
    return ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        textStyle: GoogleFonts.orbitron(fontSize: 16, fontWeight: FontWeight.w700, letterSpacing: 0.5),
      ).copyWith(
  ...
  static TextButtonThemeData textButtonTheme(ColorScheme colorScheme) {
    return TextButtonThemeData(
      style: TextButton.styleFrom(
        ...
        textStyle: GoogleFonts.orbitron(fontSize: 14, fontWeight: FontWeight.w700, letterSpacing: 0.25),
      ),
    );
  }
  ...
  static AppBarTheme lightAppBarTheme(ColorScheme colorScheme) {
    return AppBarTheme(
      ...
      shadowColor: colorScheme.shadow,
      centerTitle: false,
      titleTextStyle: TextStyle(color: colorScheme.onSurface, fontSize: 22, fontWeight: FontWeight.w600),
  ...
  static BottomNavigationBarThemeData bottomNavigationBarTheme(ColorScheme colorScheme) {
    return BottomNavigationBarThemeData(
      ...
      elevation: 8,
      selectedLabelStyle: GoogleFonts.orbitron(fontSize: 12, fontWeight: FontWeight.w700, letterSpacing: 0.5),
      unselectedLabelStyle: GoogleFonts.orbitron(fontSize: 12, fontWeight: FontWeight.w400, letterSpacing: 0.25),
    );
  }
  ...
  static ChipThemeData chipTheme(ColorScheme colorScheme) {
    return ChipThemeData(
      ...
      labelStyle: TextStyle(color: colorScheme.onSurface, fontSize: 14, fontWeight: FontWeight.w500),
      side: BorderSide(color: colorScheme.outlineVariant),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
    );
  }
  ...
  static DialogTheme dialogTheme(ColorScheme colorScheme) {
    return DialogTheme(
      ...
      titleTextStyle: TextStyle(color: colorScheme.onSurface, fontSize: 24, fontWeight: FontWeight.w600),
      contentTextStyle: TextStyle(color: colorScheme.onSurface, fontSize: 16, fontWeight: FontWeight.w400),
    );
  }
